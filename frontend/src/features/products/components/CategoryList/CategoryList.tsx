    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="relative flex items-center gap-2">
        ...
        <button
          ...
          className="flex-shrink-0 w-9 h-9 rounded-full bg-white border border-gray-200 shadow-sm flex items-center justify-center text-gray-500 hover:text-indigo-600 hover:border-indigo-300 disabled:opacity-0 disabled:pointer-events-none transition-all"
        >
        ...
        >
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                <div className="w-28 h-28 rounded-full bg-indigo-50 flex items-center justify-center text-5xl group-hover:ring-2 group-hover:ring-indigo-400 group-hover:ring-offset-2 transition-all">
                  {icon}
                </div>
