...
const data = [
  ...
  },
  {
    ...
    category: 'HARDWARE' as const,
    description:
      'Flagship GPU with 24 GB GDDR6X, ray tracing and DLSS 3 for ultimate 4K gaming.',
    imageUrl:
  ...
  },
  {
    ...
    category: 'PLAYSTATION' as const,
    description:
      'Ultra-customizable wireless controller with swappable modules and back buttons.',
    imageUrl:
  ...
  },
  {
    ...
    category: 'XBOX' as const,
    description:
      'Pro controller with hair trigger locks, wrap-around rubberized grip and adjustable tension thumbsticks.',
    imageUrl:
      'https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?w=600&q=80',
    images: [
      'https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?w=600&q=80',
  ...
  },
  {
    ...
    category: 'GAMING LAPTOPS' as const,
    description:
      'Ultra-thin gaming laptop with RTX 4080, dual-mode Mini LED display and per-key RGB.',
    imageUrl:
  ...
  },
  {
    ...
    category: 'ACCESORIOS' as const,
    description:
      'Ultra-lightweight wireless gaming mouse at 60g with HERO 2 25K sensor.',
    imageUrl:
  ...
  },
  {
    ...
    category: 'MACBOOKS' as const,
    description:
      'M3 Pro chip, Liquid Retina XDR display, 11-core CPU and 14-core GPU.',
    imageUrl:
      'https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=600&q=80',
    images: [
      'https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=600&q=80',
  ...
  // ── CELULARES ──
  {
    ...
    description:
      'A18 Pro chip, 6.9-inch Super Retina XDR display, titanio y cámara de 48 MP con Fusion Camera.',
    imageUrl:
  ...
  },
  {
    ...
    category: 'CELULARES' as const,
    description:
      'Snapdragon 8 Elite, pantalla Dynamic AMOLED 2X de 6.9" y S Pen integrado.',
    imageUrl:
  ...
  // ── REALIDAD VIRTUAL ──
  {
    ...
    description:
      'Mixed reality headset with Snapdragon XR2 Gen 2, 2064×2208 per eye and infinite virtual display.',
    imageUrl:
  ...
  },
  {
    ...
    category: 'REALIDAD VIRTUAL' as const,
    description:
      'OLED display 2000×2040 per eye, foveated rendering, Sense controllers y feedback adaptativo.',
    imageUrl:
...
export async function seedProducts(
  ...
  for (const category of categoryKeys) {
    const pool =
      CATEGORY_IMAGE_POOL[category as keyof typeof CATEGORY_IMAGE_POOL] ?? [];
    for (let i = 1; i <= EXTRA_PRODUCTS_PER_CATEGORY; i++) {
      const primaryImage =
        pool[i % pool.length] ??
        `https://picsum.photos/seed/${category.replace(/\s+/g, '')}${i}/600/600`;
      // Pick 2-3 different images from pool for carousel
      ...
      generatedData.push({
        ...
        priceInCents: Math.floor(Math.random() * 900000) * 100 + 5000000,
